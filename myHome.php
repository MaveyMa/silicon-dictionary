...
<div class="col-md-6 col-md-offset-3 site" style="width: 900px;margin-left: 12%;">
	...
	<div class="post filterSection">
	  <p><h4>When entering a career fair or attending a computer science 
              conference, you are faced with terminology (or “tech lingo”) 
              that can make the experience more intimidating or confusing. 
              Silicon Dictionary simplifies all those terms to 
              help you better communicate with companies and navigate through 
              tech events more comfortably.</h4></p>
              
	 <!--START FILTER FORM-->
	<form action="myHome.php?show=true" method="post" name="filter">
	...
	<div class="displayMenu">
		<?php
			...
			if (empty($_GET["show"])) 
			{
				printDefaultMenuUponFirstTimeVisiting();
			}
			if ($_GET["show"]=="true")
			{
